    ...
    return _createClass(LoadSearch, [{
      ...
      value: function () {
        var _requestPosts = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(e, search_term, categories, page) {
          var _this2 = this;
          var pagination, totalPage, apiUrl, params, response, posts, resultsContainer, _iterator, _step, post, date, options, postdate, _userdata, postElement, _pagination, _loop, i, _pagination2;
          return _regeneratorRuntime().wrap(function _callee$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                ...
                pagination.html('');
                totalPage = 1;
                apiUrl = new URL('/wp-json/wp/v2/posts', window.location.origin);
              ...
              case 51:
                ...
                return _context2.delegateYield(_loop(), "t1", 53);
              case 53:
                i++;
                _context2.next = 51;
                break;
      ...
      value: function load_multiselect() {
        ...
        list.each(function () {
          ...
          $(this).on('click', function (e) {
            e.preventDefault();
            var checked = $(_this).find('input')[0]; // Get the input element in the clicked li
            ...
            var option = $("#".concat(_this.className)); // Get the option corresponding to the clicked li
